...
LightingCube::LightingCube(Shader *shader_program, glm::vec3 light_position, glm::vec3 light_color, glm::vec3 object_color, float size_x, float size_y, float size_z):
    Cube(shader_program, size_x, size_y, size_z),
...
void LightingCube::draw(glm::mat4& model, glm::mat4& view, glm::mat4& projection) {
